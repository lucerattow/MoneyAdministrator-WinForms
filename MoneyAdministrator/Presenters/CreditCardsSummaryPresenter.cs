...
{
    public class CreditCardsSummaryPresenter
    {
        //fields
        private ICreditCardsSummaryView _view;
        private string _databasePath;
        private Action _closeView;

        //properties
        public ICreditCardsSummaryView View
        {
            get { return _view; }
        }

        public CreditCardsSummaryPresenter(string databasePath, Action closeView)
        {
